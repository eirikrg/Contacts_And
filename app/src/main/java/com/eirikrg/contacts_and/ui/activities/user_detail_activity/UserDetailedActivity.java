...
public class UserDetailedActivity extends AppCompatActivity implements BaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    this.userDetailedActivityViewModel =
        new ViewModelProvider(this).get(UserDetailedActivityViewModel.class);
  ...
  private void generateQRCode() {
    ...
    new MaterialAlertDialogBuilder(UserDetailedActivity.this).setView(alertDialogQr).show();
  }
  ...
  public void initializeListeners() {
    ...
    this.floatingActionButtonUser.setOnClickListener(
        v -> {
          showAddContactConfirmationDialog();
        });
    this.buttonQr.setOnClickListener(
        v -> {
          generateQRCode();
        });
  }
  ...
  public void onRequestPermissionsResult(
    ...
    if (requestCode == PERMISSIONS_REQUEST_READ_CONTACTS) {
      if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
        ...
        Toast.makeText(this, getString(R.string.permission_not_accepted), Toast.LENGTH_SHORT)
            .show();
      }
    }
  }
