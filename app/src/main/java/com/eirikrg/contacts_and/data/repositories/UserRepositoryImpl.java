...
public class UserRepositoryImpl extends BaseRepository<UsersApiResponse, List<User>, UsersMapper>
    implements com.eirikrg.domain.repositories.UserRepository {
